      ...
      <div className="mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
          ...
          <button 
            ...
            className="mt-4 sm:mt-0 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 transition-colors"
          >
...
const KanbanColumn = ({ column, searchTerm, onEditTask, onViewTask, onDeleteTask, onDragStart, onDragEnd, onDragOver, onDrop }) => {
      ...
      <div className={`px-4 py-3 ${style.headerBg} ${style.headerText} border-b border-gray-200`}>
        <div className="flex items-center justify-between">
          <h3 className="text-sm font-semibold capitalize">
            {column.title || column.status.replace('_', ' ')}
          </h3>
...
const TaskCard = ({ task, onEdit, onView, onDelete, onDragStart, onDragEnd }) => {
